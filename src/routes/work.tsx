...
const caseStudies = [
  {
    ...
    overview:
      'Full ownership of a large-scale S2hopify ecosystem supporting a fashion and lifestyle D2C brand, managing SKUs and driving visitors through strategic merchandising, SEO, and seasonal campaign execution.',
    deliverables: [
